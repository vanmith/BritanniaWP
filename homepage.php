...
<div class="container" id="main-content-wrapper">
	<div class="row">
		...
		<div class="col-lg-4">
			<div id="timeline">
				<span class="timeline-title">Price Match Promise</span>
				<p class="timeline-text">Completed your order and found a better price elsewhere? Let us know and we'll be happy to send you a cheque for £50.</p>
			</div>
			<div id="timeline">
				<span class="timeline-title">Price Match Promise</span>
				<p class="timeline-text">Completed your order and found a better price elsewhere? Let us know and we'll be happy to send you a cheque for £50.</p>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 faqs">
				...
				<div class="faq">
					<div class="faq_question"><h3>I'm interested in leasing but I don't know anything about it. Can you advise me?</h3></div>
					<div class="faq_answer_container">
						<div class="faq_answer"><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p></div>
					</div>		
				</div>
				<div class="faq">
					<div class="faq_question"><h3>I've always bought my car, why should I lease one?</h3></div>
					<div class="faq_answer_container">
						<div class="faq_answer"><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p></div>
					</div>		
				</div>
				<div class="faq">
					<div class="faq_question"><h3>Your prices seem very low, what's the catch?</h3></div>
					<div class="faq_answer_container">
						<div class="faq_answer"><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p></div>
					</div>		
				</div>
				<div class="faq">
					<div class="faq_question"><h3>I can't see the exact model I want to lease, what do I do?</h3></div>
					<div class="faq_answer_container">
						<div class="faq_answer"><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p></div>
					</div>		
				</div>
				<div class="faq">
					<div class="faq_question"><h3>Are the cars you supply brand new cars?</h3></div>
					<div class="faq_answer_container">
						<div class="faq_answer"><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p></div>
					</div>		
				</div>
